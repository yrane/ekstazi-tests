...
public class IdentityTest {
    ...
    public void testTrueFalseTrue() {
        assertEquals(1, CoverageExample.identity(0, true, false, true));
    }
    
    @Test 
    public void testTrueFalseFalse() {
        assertEquals(1, CoverageExample.identity(0, true, false, false));
    }
    
    @Test 
    public void testFalseTrueTrue() {
        assertEquals(-1, CoverageExample.identity(0, false, true, true));
    }
    
    @Test 
    public void testFalseTrueFalse() {
        assertEquals(-1, CoverageExample.identity(0, false, true, false));
    }
